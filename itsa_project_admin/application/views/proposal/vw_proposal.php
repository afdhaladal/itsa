<div id="layoutSidenav_content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6"><a href="<?= base_url('Proposal/tambah_proposal') ?>" class="btn btn-info mb-2">Ajukan Proposal</a></div>
            <div class="col-md-12">
                <table class="table">
                    <thead>
                        <tr>
                        ...
                        <?php foreach ($proposal as $us) : ?>
                            <?php if ($us['nama'] == $this->session->userdata('id')) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('./assets/img/proposal/') . $us['file_path']; ?>" target="_blank" class="btn btn-info btn-icon-split btn-sm">
